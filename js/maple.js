...
var vidLocation = $('#vid').offset().top;
 if ( vidLocation > (windowH-10)){
...
function buttonH(){
 var pos = $(window).scrollTop();
 var windowH = $(window).height();
var buttonLocation= $('#supportB1').offset().top;
 if ( buttonLocation > (windowH-10)){
